...
from users.api.views import (UserApiViewSet, users_are_activate, users_waiting_for_activate, roles_all, CustomTokenObtainPairView,
                             get_info_user, users_by_university)
...
urlpatterns = [
    ...
    path('user/by-university/<id_university>', users_by_university),
    path('role/', roles_all),
